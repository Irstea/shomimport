...
-- object: shomimport | type: ROLE --
-- DROP ROLE IF EXISTS shomimport;
CREATE ROLE shomimport WITH 
	LOGIN
	UNENCRYPTED PASSWORD 'shomImport';
-- ddl-end --
...
CREATE SCHEMA maree;
-- ddl-end --
ALTER SCHEMA maree OWNER TO shomimport;
-- ddl-end --
...
CREATE SEQUENCE maree.coef_coef_id_seq
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE maree.coef_coef_id_seq OWNER TO shomimport;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE maree.coef OWNER TO shomimport;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE maree.coef_type OWNER TO shomimport;
-- ddl-end --

INSERT INTO maree.coef_type (coef_type_id, coef_type_name) VALUES (E'1', E'pleine eau');
-- ddl-end --
INSERT INTO maree.coef_type (coef_type_id, coef_type_name) VALUES (E'2', E'basse eau');
-- ddl-end --
INSERT INTO maree.coef_type (coef_type_id, coef_type_name) VALUES (E'3', E'moyenne journalière');
-- ddl-end --
...
CREATE SEQUENCE maree.station_station_id_seq
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE maree.station_station_id_seq OWNER TO shomimport;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE maree.station OWNER TO shomimport;
-- ddl-end --
...
-- ddl-end --
ALTER VIEW maree.v_coef OWNER TO shomimport;
-- ddl-end --
